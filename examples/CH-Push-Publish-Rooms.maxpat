...
,
									"patching_rect" : [ 464.0, 486.0, 391.0, 171.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "jit_matrix" ],
									"patching_rect" : [ 800.0, 15.345338983050851, 63.05797101449275, 55.309322033898304 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 464.0, 430.0, 116.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 570.0, 352.5, 244.0, 37.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 464.0, 360.0, 97.0, 22.0 ],
									"text" : "r fromCH-Server"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 82.0, 440.0, 238.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 117.0, 352.5, 244.0, 37.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 26.0, 360.0, 83.0, 22.0 ],
									"text" : "r toCH-Server"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 26.0, 201.0, 393.0, 100.0 ],
									"text" : "Push and Publish. \n\nYou might find one method more useful at times. \n\nUse the next two tabs to dive into using Push and Publish in the context of Rooms. "
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 26.0, 153.0, 336.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 26.0, 486.0, 323.0, 171.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 26.0, 9.0, 913.0, 122.0 ],
...
,
					"patching_rect" : [ 22.0, 12.0, 43.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 518.0, 337.0, 412.0, 69.0 ],
									"text" : "Other targets can be rooms or specific users. You can use the provided submodules: CH-Client and CH-Rooms to see available rooms and users. (You do not need to be in/joined a room to send messages to that room.)."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 212.5, 440.0, 256.0, 37.0 ],
									"text" : "Follows the construct: \n<mode> <target> <header> [<value>]"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "Target call be 'all', <a sepecific room>, and <a specific user>.",
...
,
					"patching_rect" : [ 144.0, 11.0, 58.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 76.0, 43.5, 150.0, 20.0 ],
					"text" : "You're in Edit Mode!"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1420.0, 184.0, 307.0, 38.0 ],
									"text" : "This is a clipping! You can right-click and select from \nPaste From > Collab-Hub Modules > Route Menus",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 1074.0, 386.5, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1023.0, 386.5, 35.0, 22.0 ],
									"text" : "clear"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 209.5, 343.5, 256.0, 37.0 ],
									"text" : "Follows the construct: \n<mode> <target> <header> [<value>]"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 21.0, 84.0, 607.0, 38.0 ],
									"text" : "Push allows users to direct messages to a target. The target does not have to observe/subscribe to your data. You push to it the destination. The target can do what they please with it. "
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1083.5, 419.5, 1070.0, 419.5, 1070.0, 373.5, 1032.5, 373.5 ],
									"source" : [ "obj-17", 0 ]
								}
...
,
					"patching_rect" : [ 76.0, 12.0, 54.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
