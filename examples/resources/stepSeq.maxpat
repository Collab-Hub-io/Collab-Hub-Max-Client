...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 718.800536999999963, 737.225464000000102, 30.0, 30.0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-120" : [ "Max pulse[1]", "Max pulse", 0 ],
			"obj-125" : [ "NoteGrid", "NoteGrid", 0 ],
			"obj-130" : [ "mute", "mute", 0 ],
			"obj-155" : [ "Swing amount", "Swing amount", 0 ],
			"obj-157" : [ "Swing enable", "Swing enable", 0 ],
			"obj-185" : [ "Sequence", "Sequence", 0 ],
			"obj-2" : [ "trans_trig", "trans_trig", 0 ],
			"obj-22" : [ "Pattern", "Pattern", 0 ],
			"obj-25" : [ "GateTime", "GateTime", 0 ],
			"obj-28" : [ "Sync", "Sync", 0 ],
			"obj-4" : [ "live.text", "live.text", 0 ],
			"obj-89" : [ "Reset", "Reset", 0 ],
			"obj-95" : [ "Steps", "Steps", 0 ],
			"obj-96" : [ "Pulse", "Pulse", 0 ],
			"parameterbanks" : 			{
