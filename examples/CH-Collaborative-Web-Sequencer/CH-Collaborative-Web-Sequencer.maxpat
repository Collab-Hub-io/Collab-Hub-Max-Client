...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 596.0, 84.0, 323.0, 171.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 6.0, 913.0, 122.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 60.0, 704.0, 60.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 827.0, 55.0, 22.0 ],
					"text" : "dac~ 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 2.0, 660.5, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "local_seq_four_tracks.maxpat",
					"numinlets" : 2,
					"numoutlets" : 2,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 2.0, 263.0, 803.0, 352.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 197.0, 959.0, 355.0 ],
					"viewvisibility" : 1
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "local_seq_four_tracks.maxpat",
				"bootpath" : "~/GitHub/Collab-Hub-Client-SH/examples/CH-Collaborative-Web-Sequencer",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
