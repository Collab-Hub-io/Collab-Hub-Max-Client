...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 539.0, 12.0, 400.0, 220.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 568.0, 335.5, 71.0, 22.0 ],
					"text" : "v username"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 12.5, 246.0, 44.0, 22.0 ],
					"text" : "sel 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 233.0, 226.5, 121.0, 33.0 ],
					"text" : "unecessary once we implement preset"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 355.0, 17.084745999999999, 110.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1038.200000000000045, 324.5, 79.0, 22.0 ],
					"text" : "print ERROR"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 190.333333333333371, 400.5, 31.0, 22.0 ],
					"text" : "t b s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 190.333333333333371, 347.0, 32.0, 22.0 ],
					"text" : "t b 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "bang" ],
					"patching_rect" : [ 190.333333333333371, 371.0, 141.0, 22.0 ],
					"text" : "dialog Enter namespace:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 141.0, 429.5, 111.0, 22.0 ],
					"text" : "pack script start s s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 233.0, 287.5, 32.0, 22.0 ],
					"text" : "t b 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "bang" ],
					"patching_rect" : [ 233.0, 311.5, 199.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 101.5, 287.5, 63.0, 22.0 ],
					"text" : "script stop"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 976.799999999999955, 324.5, 58.0, 22.0 ],
					"text" : "print chat"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 371.0, 180.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 919.200000000000045, 351.5, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 654.0, 442.5, 94.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 654.0, 418.5, 57.0, 22.0 ],
					"style" : "velvet",
					"text" : "tosymbol"
				}
...
,
					"patching_rect" : [ 643.0, 392.5, 30.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.5, 525.25, 85.0, 22.0 ],
					"text" : "s toCH-Server"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 435.0, 335.5, 131.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 435.0, 287.5, 32.0, 22.0 ],
					"text" : "t b 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "bang" ],
					"patching_rect" : [ 435.0, 311.5, 199.0, 22.0 ],
					"text" : "dialog Enter username (no spaces):"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 804.0, 285.5, 307.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 804.0, 261.5, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.5, 287.5, 87.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 271.0, 180.0, 99.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 643.0, 239.5, 128.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 435.0, 263.5, 110.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 210.0, 4.0, 108.0, 18.0 ],
					"style" : "velvet",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 861.600000000000023, 324.5, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 190.0, 4.0, 18.0, 18.0 ],
					"style" : "velvet"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 12.5, 212.5, 55.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 136.0, 4.0, 52.0, 18.0 ],
					"style" : "velvet",
					"text" : "Connect",
					"texton" : "Connect",
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 294.0, 318.0, 100.0, 16.161616161616163 ],
